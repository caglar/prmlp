                ...
                ## Job name
                #PBS -N dbi_44b8ca1abd5

                ## log out/err files
                # We cannot use output_file and error_file here for now.
                # We will use dbi_...out-id and dbi_...err-id instead
                #PBS -o /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test.py_._2012-08-18_19-11-59.854196/dbi_44b8ca1abd5.out
                #PBS -e /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test.py_._2012-08-18_19-11-59.854196/dbi_44b8ca1abd5.err
...
export MKL_NUM_THREADS=1
                ...
                /bin/bash -l -e /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test.py_._2012-08-18_19-11-59.854196/launcher
