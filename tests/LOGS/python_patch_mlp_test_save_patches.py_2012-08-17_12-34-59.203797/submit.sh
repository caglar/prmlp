                ...
                ## Job name
                #PBS -N dbi_5714732bbfd

                ## log out/err files
                # We cannot use output_file and error_file here for now.
                # We will use dbi_...out-id and dbi_...err-id instead
                #PBS -o /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test_save_patches.py_2012-08-17_12-34-59.203797/dbi_5714732bbfd.out
                #PBS -e /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test_save_patches.py_2012-08-17_12-34-59.203797/dbi_5714732bbfd.err
...
export MKL_NUM_THREADS=1
                ...
                /bin/bash -l -e /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test_save_patches.py_2012-08-17_12-34-59.203797/launcher
