                ...
                ## Job name
                #PBS -N dbi_f4212617a25

                ## log out/err files
                # We cannot use output_file and error_file here for now.
                # We will use dbi_...out-id and dbi_...err-id instead
                #PBS -o /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test_multi_dataset.py_._2012-08-17_05-16-18.624459/dbi_f4212617a25.out
                #PBS -e /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test_multi_dataset.py_._2012-08-17_05-16-18.624459/dbi_f4212617a25.err
...
export MKL_NUM_THREADS=1
                ...
                /bin/bash -l -e /home/gulcehre/codes/python/experiments/arcade_ds_exps/pretrained_mlp/prmlp_clean/tests/LOGS/python_patch_mlp_test_multi_dataset.py_._2012-08-17_05-16-18.624459/launcher
