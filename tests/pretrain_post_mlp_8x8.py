...
if __name__=="__main__":
    ...
    ds.setup_pretraining_dataset(data_path=data_new_100k, patch_size=patch_size, train_split_scale=0.8, normalize_inputs=False)
    ...
    post_mlp = PostMLP(x, n_in=no_of_patches * no_of_classes, n_hiddens=[128],
