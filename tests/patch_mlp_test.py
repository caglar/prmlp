...
if __name__ == "__main__":
    ...
    ds.setup_pretraining_dataset(data_path="/RQusagers/gulcehre/dataset/pentomino/rnd_pieces/pento64x64_5k_fixed_seed_43112222_16patches_rnd.npy", patch_size=patch_size, normalize_inputs=False)
